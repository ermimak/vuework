...
const home = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/home');
const about = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/about');
const allBlogs = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/blogs');
const blogDetails = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/blog_details');
const brands = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/brands');
const sellers = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/all-seller');
const campaignDetails = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/campaign_details');
const allCampaign = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/all_campaign');
const allCategory = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/category');
const contact = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/contact');
const dailyDeals = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/daily-deals');
const productDetails = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/product-details');
const trackOrder = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/track-order');
const afterTrackOrder = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/after-track-order');
const checkout = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/checkout');
const payment = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/payment');
const orderConfirmation = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/order-confirmation');
const cart = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/cart');
const login = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/login');
const register = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/register');
const seller_register = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/seller_register');
const resetPassword = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/forgot-password');
const wishlist = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/wishlist');
const filterProducts = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/filter_sidebar');
const flashSale = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/flash-sale');
const compareList = () => import(/*webpackPrefetch: true */
    '../views/components/frontend/pages/compare-list');
const changePassword = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/change_password');
const editProfile = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/edit-profile');
...
const migrateSeller = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/migrate-to-seller');

const giftVoucher = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/gift-voucher');
const notification = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/notification');
const orderHistory = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/order-history');
const dashboard = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/dashboard');
const addresses = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/addresses');
const getInvoice = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/get-invoice');
const reward = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/addons/rewards');
const myWallet = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/wallet');
const shop = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/shop');
const followedShop = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/followed-shop');
const digitalProductOrders = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/user/digital-product-orders');
const videoShop = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/addons/video_shop');
const videoShopDetails = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/addons/video_shop_details');
const error_404 = () => import(/* webpackPrefetch : true" */
    '../views/components/errors/not_found');
const affiliate_register = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/affiliate_users/affiliate_register');
const affiliate_program = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/affiliate_users/affiliate_program');
const affiliate_system = () => import(/* webpackPrefetch: true */
    '../views/components/frontend/pages/affiliate_users/affiliate_system');

export const routes = [
    {
        path: '/',
        component: () => import(/* webpackPrefetch : true" */'../views/components/frontend/master'),
